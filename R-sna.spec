...
Source0  : https://cran.r-project.org/src/contrib/sna_2.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725791900
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/sna/libs/sna.so
/V4/usr/lib64/R/library/sna/libs/sna.so
